<div class="step data-step goalName" data-step="2" data-value='0'>                    
                     ...
                     <div class="form-group tooltip-hover append-template-goal-name">
                      <div class="outborder">
                        <textarea ng-mouseenter="pressEnter($event)" rows="3" data-toggle="tooltip"  data-html="true" title="" data-autoresize id="name_goal" name="name_goal" ng-model="name_goal" ng-init="name_goal='<?php echo e(isset($goalDetails) ? $goalDetails->gb_goal_name: null); ?>'" placeholder="" class="form-control" required><?php echo e(isset($goalDetails)?$goalDetails->gb_goal_name:null); ?></textarea>
                     </div>
                     </div>
                  </div>
...
</script><?php /**PATH /Users/mahendra/Documents/projects/epicFit/epicfitlaravelv6/resources/views/Result/partials/goal-steps/custom/step2.blade.php ENDPATH**/ ?>