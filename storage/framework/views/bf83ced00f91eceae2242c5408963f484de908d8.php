<div class="step data-step goalDetail" data-step="11">
  ...
  <div class="form-group">
   ...
   <input type="radio" name="goal_seen" value="Selected friends" <?php echo e(isset($goalDetails) && $goalDetails->gb_goal_seen == 'Selected friends'?'checked':''); ?>>
   <span class="checkmark"></span>
   </label>
</div>
   <div class="form-group">
      <label class="container_radio version_2">Everyone
      <input type="radio" name="goal_seen" value="everyone" <?php echo e(isset($goalDetails) && $goalDetails->gb_goal_seen == 'everyone'?'checked':''); ?>>
      <span class="checkmark"></span>
      </label>
   </div>
   <div class="form-group">
      <label class="container_radio version_2">Just Me
      <input type="radio" name="goal_seen" value="Just_me" <?php echo e(isset($goalDetails) && $goalDetails->gb_goal_seen == 'Just_Me'?'checked':''); ?>>
      <span class="checkmark"></span>
      </label>
   </div>
...
</script><?php /**PATH /Users/mahendra/Documents/projects/epicFit/epicfitlaravelv6/resources/views/Result/partials/goal-steps/custom/step11.blade.php ENDPATH**/ ?>