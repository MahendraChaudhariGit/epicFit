<div class="step data-step" data-step="14">
    ...
    <div class="form-group">
     ...
     <input type="radio" name="gb_milestones_seen" value="Selected friends" <?php echo e(isset($milestonesData) && $milestones->gb_milestones_seen == 'Selected friends'?'checked':''); ?>>
     <span class="checkmark"></span>
     </label>
  </div>
     <div class="form-group">
        <label class="container_radio version_2">Everyone
        <input type="radio" name="gb_milestones_seen" value="everyone" <?php echo e(isset($milestonesData) && $milestones->gb_milestones_seen == 'everyone'?'checked':''); ?>>
        <span class="checkmark"></span>
        </label>
     </div>
     <div class="form-group">
        <label class="container_radio version_2">Just me
           <input type="radio" name="gb_milestones_seen" value="Just_Me"  <?php echo e(isset($milestonesData) && $milestones->gb_milestones_seen == 'Just_Me'?'checked':''); ?>>
        <span class="checkmark"></span>
        </label>
     </div>
...
</script><?php /**PATH /Users/mahendra/Documents/projects/epicfitlaravelv6/resources/views/Result/partials/goal-steps/custom/step14.blade.php ENDPATH**/ ?>