<div class="step data-step" data-step="6">
    <div class="row">
     ...
     <div class="form-group template-accomplish">
      <div class="outborder">
        <textarea ong-blur="pressEnter($event)" data-toggle="tooltip" data-html="true" title="" data-autoresize id="accomplish" id="accomplish" name="accomplish" ng-model="accomplish" ng-init="accomplish='<?php echo e(isset($goalDetails) ? $goalDetails->gb_important_accomplish: null); ?>'" placeholder="" class="form-control" required><?php echo e(isset($goalDetails)?$goalDetails->gb_important_accomplish:null); ?></textarea>
      </div>
     </div>
</div>
...
</script><?php /**PATH /Users/mahendra/Documents/projects/epicFit/epicfitlaravelv6/resources/views/Result/partials/goal-steps/custom/step6.blade.php ENDPATH**/ ?>