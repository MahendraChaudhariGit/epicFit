     ...
     $.ajax({
         ...
         success: function (data) {
            ...
            if(data.data && data.data['life-change'] != undefined && data.data['life-change'].length > 0){
              data.data['life-change'].map(data => {
...
</script><?php /**PATH /Users/mahendra/Documents/projects/epicFit/epicfitlaravelv6/resources/views/Result/partials/goal-steps/custom/step5.blade.php ENDPATH**/ ?>