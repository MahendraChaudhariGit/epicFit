...
<div class="step data-step" data-step="3">
                    <div class="row">
                     ...
                     <div class="form-group template-description-achieve">
                      <div class="outborder">
                        <textarea ng-blur="pressEnter($event)" id="description" data-toggle="tooltip" data-html="true" title="" data-autoresize id="describe_achieve" name="describe_achieve" ng-model="describe_achieve" ng-init="describe_achieve='<?php echo e(isset($goalDetails) ? $goalDetails->gb_achieve_description: null); ?>'" placeholder="" class="form-control" required><?php echo e(isset($goalDetails)?$goalDetails->gb_achieve_description:null); ?></textarea>
                      </div>
                     </div>
                     <div class="">
  ...
  <div class="heading-text border-head mb-10">
                        <div class="padding-left-20 custom-padding">
                           <div class="form-group upload-group m-t-10" style="padding-left: 3px">
                              <input type="hidden" name="prePhotoName" value="<?php echo e(isset($goalDetails)?$goalDetails->gb_image_url:null); ?>">
                              ...
                              <div class="m-t-10">
                                 <?php if(isset($goalDetails->gb_image_url) && ($goalDetails->gb_image_url != '')): ?>
                                 <img src="<?php echo e(dpSrc($goalDetails->gb_image_url)); ?>" class="SYGPreviewPics previewPics"  />
                                 <?php else: ?>
...
</script><?php /**PATH /Users/mahendra/Documents/projects/epicFit/epicfitlaravelv6/resources/views/Result/partials/goal-steps/custom/step3.blade.php ENDPATH**/ ?>