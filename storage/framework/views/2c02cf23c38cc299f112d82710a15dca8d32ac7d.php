<div class="step data-step" data-step="9">
  <div class="row">
   ...
   <div class="form-group template-relevant-goal-event">
    <div class="outborder">
      <textarea ng-blur="pressEnter($event)" data-toggle="tooltip" title="" data-autoresize id="gb_relevant_goal_event" name="gb_relevant_goal_event" ng-model="gb_relevant_goal_event" ng-init="gb_relevant_goal_event='<?php echo e(isset($goalDetails) ? $goalDetails->gb_relevant_goal_event: null); ?>'" placeholder="" class="form-control" required><?php echo e(isset($goalDetails)?$goalDetails->gb_relevant_goal_event:null); ?></textarea>
    </div>
   </div>
</div>
...
</script><?php /**PATH /Users/mahendra/Documents/projects/epicFit/epicfitlaravelv6/resources/views/Result/partials/goal-steps/custom/step9.blade.php ENDPATH**/ ?>