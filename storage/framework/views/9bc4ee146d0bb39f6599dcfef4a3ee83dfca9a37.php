...
<div class="step data-step milestoneData" data-step="13" data-value="0" >
    ...
    <input type="hidden" id="goal_buddy_saved_id" value="<?php echo e(Session::get('goal_buddy_id')); ?>">    
    ...
    <div class="row dd-item m-30">
     ...
     <div class="dd mile_section row" >
        <ul class="dd-list">
           <?php if((isset($milestonesData))&&($milestonesData->count() > 0)): ?>
           <?php $__currentLoopData = $milestonesData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $milestones): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
           <li class="dd-item row mb-10 " data-milestones-id="<?php echo e($milestones->id); ?>" style="line-height: 20px; !important">
              <div class="milestones-form">
                 <div class="col-xs-5 milestones-date-cls">
                    <input data-toggle="tooltip" title="Milestone Name" class="form-control milestones-name" value="<?php echo e($milestones->gb_milestones_name); ?>" data-milestones-id="<?php echo e($milestones->id); ?>" type="text" disabled="disabled" />
                 </div>
                <div class="col-xs-5 milestones-date-cls date">
                    <input data-toggle="tooltip" title="Milestone Due Date" class="form-control milestones-date datepicker_SYG4" autocomplete="off" required="" value="<?php echo e($milestones->gb_milestones_date); ?>" type="text" disabled="disabled" />
                </div>
                 <div class="col-xs-2 pencil_find_sibling">

                    <a><i class="fa fa-times new-delete-milestone-info" style="margin-right: 5px" data-milestones-id="<?php echo e($milestones->id); ?>"></i></a>
                    <!-- <a><i class="fa fa-pencil edit-milestone-info hidden" style="display:inline; font-size: 16px"></i></a> -->
                    <a><i class="fa fa-save save-milestone-info" data-milestones-id="<?php echo e($milestones->id); ?>" style="display:none"></i></a>
                 </div>
              </div>
           </li>
     ...
     <!--  <div class="form-group">
        <div class="row">
            <a><i class="fa fa-times delete-milestone-info" style="margin-right: 5px" data-milestones-id="<?php echo e($milestones->id); ?>"></i></a>
...
</script><?php /**PATH /Users/mahendra/Documents/projects/epicFit/epicfitlaravelv6/resources/views/Result/partials/goal-steps/custom/step13.blade.php ENDPATH**/ ?>