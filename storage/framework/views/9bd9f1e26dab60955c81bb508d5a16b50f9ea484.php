        ...
        <ul class="nav navbar-right">
            <li class="dropdown current-user">
                ...
                <a href class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="<?php echo e(dpSrc(Auth::user()->profilePic, Auth::user()->gender)); ?>" alt="<?php echo e(Auth::user()->fullName); ?>" class="clientPreviewPics ">
                   
                      
                  
                    <span class="username">
                        <span data-realtime="firstName"><?php echo e(Auth::user()->name); ?><b class="caret" style="float:right;"></b></span>
...
<!--         <a class="pull-right menu-toggler visible-xs-block" id="menu-toggler" data-toggle="collapse" href=".navbar-collapse">
    ...
    <div class="navbar-collapse collapse">
        <h1 class="logo">
            <a href="<?php echo e(url('/new-dashboard')); ?>">
               <!--   <img src="<?php echo e(url('result/images/epic-icon.png')); ?>" alt="Epic Result" style="width: 20px;">  -->
        ...
        <ul class="nav navbar-right">
                        ...
                        <div class="drop-down-wrapper ps-container">
                            <div class="list-group no-margin">
                                <a class="media list-group-item" href="">
                                    <img class="img-circle" alt="..." src="<?php echo e(asset('images/user.png')); ?>">
            ...
            <li class="dropdown current-user">
                <a href class="dropdown-toggle" data-toggle="dropdown">
                        <?php
                        $client = \App\Clients::where('id',Auth::user()->account_id)->first();
                        ?>
                        <img src="<?php echo e(dpSrc(Auth::user()->profilePic, $client->gender)); ?>" alt="<?php echo e(Auth::user()->fullName); ?>" class="clientPreviewPics ">
...
<script>
        ...
        console.log(window.laravel_echo_port + 'port');
</script>
...
<script src="<?php echo e(url('/js/laravel-echo-setup.js')); ?>" type="text/javascript"></script>
...
<!-- end: TOP NAVBAR --><?php /**PATH /Users/mahendra/Documents/projects/epicFit/epicfitlaravelv6/resources/views/Result/partials/includes/navbar.blade.php ENDPATH**/ ?>