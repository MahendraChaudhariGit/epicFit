<div class="step data-step" data-step="8">
  ...
  <div class="row">
   ...
   <div class="form-group template-relevant-goal">
    <div class="outborder">
      <textarea ng-blur="pressEnter($event)" data-toggle="tooltip" title="" data-autoresize id="gb_relevant_goal" name="gb_relevant_goal" ng-model="gb_relevant_goal" ng-init="gb_relevant_goal='<?php echo e(isset($goalDetails) ? $goalDetails->gb_relevant_goal: null); ?>'" placeholder="" class="form-control" required><?php echo e(isset($goalDetails)?$goalDetails->gb_relevant_goal:null); ?></textarea>
    </div>
   </div>
</div>
...
</script><?php /**PATH /Users/mahendra/Documents/projects/epicFit/epicfitlaravelv6/resources/views/Result/partials/goal-steps/custom/step8.blade.php ENDPATH**/ ?>