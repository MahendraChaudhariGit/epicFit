<div class="step data-step" data-step="10">
 ...
 <div class="form-group">
  <input type="text" data-toggle="tooltip" title="" class="form-control vdp" name="due_date" id='datepicker_SYG' autocomplete="off" value="<?php echo e(isset($goalDetails)? $goalDetails->goal_due_date:null); ?>"  required data-provide="datepicker">
 </div>
...
<script type="text/javascript">
 var startDate = null;
//  if(oldStartDate){
//     var start_date =  moment(oldStartDate, 'ddd, D MMM YYYY').format("YYYY-MM-DD");
//     $('#datepicker_SYG').datepicker('setStartDate', start_date);
//  }
...
</script><?php /**PATH /Users/mahendra/Documents/projects/epicFit/epicfitlaravelv6/resources/views/Result/partials/goal-steps/custom/step10.blade.php ENDPATH**/ ?>