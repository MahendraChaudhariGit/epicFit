$(document).ready(function () {
    ...
    function renderDefaultDataToModal(LocalKey,DefaultObject) {
        ...
        if (LocalKey == 'partnership_expenses'){
            rendorpartnershipJSONObejct(JSON.parse(localStorage.getItem(LocalKey)));
        }
    }
    /**************~ End  Common - For -  all ~**********************/
...
/* * * * * * * * * * * * * start setup expenses  * * * * * * * * * * * * */
    var setupObject =  {"CLOTHING":[{"Shoes":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Uniforms":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Other":0,"Incl. Tax":1,"timeframe":"oneoff"}],"COMMUNICATION":[{"Landline":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Mobiles":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Modem / Router":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Other":0,"Incl. Tax":1,"timeframe":"oneoff"}],"EQUIPMENT":[{"Equipment (See operations manuals for estimated costs)":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Startup Equipment":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Other":0,"Incl. Tax":1,"timeframe":"oneoff"}],"MISCELANEOUS":[{"Cleaning supplies":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Toiletries / Hygeine products":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Vaccuum":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Other":0,"Incl. Tax":1,"timeframe":"oneoff"}],"OFFICE & STATIONARY":[{"Computers":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Furniture":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Office chairs":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Office desks":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Printer":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Reception desk":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Other":0,"Incl. Tax":1,"timeframe":"oneoff"}],"PREMISES":[{"Business signage":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Purchase/Deposit of Premises":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Renovation / Fitout":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Other":0,"Incl. Tax":1,"timeframe":"oneoff"}],"PROMOTION & MARKETING":[{"Apparel / Water Bottles / Towels":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Business Cards":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Flyers / Brochures":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Letterheads":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Logo Design":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Web Design cost":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Other":0,"Incl. Tax":1,"timeframe":"oneoff"}],"REGISTRATION / TRAINING":[{"License Fee (May include some additional products/equipment in the list)":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Ongoing Training / Continued Education":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Registration":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Business Registration Fees":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Other":0,"Incl. Tax":1,"timeframe":"oneoff"}],"VEHICLE & TRAVEL":[{"Purchase Vehicle":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Signage & Design":0,"Incl. Tax":1,"timeframe":"oneoff"},{"WOF":0,"Incl. Tax":1,"timeframe":"oneoff"},{"Registration":0,"Incl. Tax":1,"timeframe":"oneoff"}]};
      ...
      renderDefaultDataToModal('setup_expenses',setupObject);
       ...
       $(document).on('click','.setup_expense_submit',function(){
          ...
          $('.setup_fill_data').each(function(){
              ...
              if($(this).attr('gst-incl') == 'true'){ // IF INCL IS YES
                gst_tax += 0;
              } else { // IF INCL IS NO
                // gst_percetage comes from db
                var tax = ($(this).val() * gst_percetage) / 100; // ACTUAL TAX AMOUNT BEING CALCULATED
                gst_tax += tax;
              }
              se_calculated += parseFloat($(this).val());
          });

          se_calculated += gst_tax; // Adding GST Tax
          
          if($('#is_gst_registered').val() == 1){ // IF GST IS YES 
            var countGst = (parseFloat($('.gst-percentage').val()) + 100) / 100;
            se_gst_excl += parseFloat(se_calculated) / countGst;
            var gst_paid = parseFloat(se_calculated) - parseFloat(se_gst_excl); 
          }

          $('#se_calculated').val((se_calculated).toFixed(2)); 
          $('#se_gst_excl').val((se_gst_excl).toFixed(2));
          $('#se_gst_paid').val((gst_paid).toFixed(2));
       ...
       $(document).on('click', '.add_new_setup_field_btn', function () {
           ...
           ContentsArray[selectedSection].push({ [inputLable] : 0 , "Incl. Tax" : 1, "timeframe" : "oneoff" });
            ...
            var fields = '';
               ...
               for (var j=0;j<$FieldKeys.length ; j++) {
                   ...
                   fields += '<tr class="dynamic_input_box" style="width: 100%;">' +
                       ...
                       'role="button" value="Small Default" data-setup-parent-id="'+$keys[i]+
                       '"title="Edit field" data-setup-field-id="'+$inputFieldKeys[0]+'">' + 
               ...
               setup_contents +=  '<div class="setup-dynamic-section"><strong class="dynamic_title" data-title="'+$keys[i]+'">' + $keys[i] +
                   ...
                   'role="button" value="Small Default" title="Edit section" data-setup-section-id="'+$keys[i]+'">' +
       ...
       // $('.setup-chk-lbl').click(false);
/* * * * * * * * * * * * * end setup expenses  * * * * * * * * * * * * */

/* * * * * * * * * * * * * start business expenses  * * * * * * * * * * * * */
    var timeframe = "weekly";
    if(setting_pref_timeframe != null)
    {
      var timeframe = setting_pref_timeframe;
    }
    // var businesObject = {"COMMUNICATION":[{"Internet":0,"Incl. Tax":0,"timeframe":"weekly"},{"Landline":0,"Incl. Tax":0,"timeframe":"weekly"},{"Mobile":0,"Incl. Tax":0,"timeframe":"weekly"},{"Modem / Router":0,"Incl. Tax":0,"timeframe":"weekly"},{"Other":0,"Incl. Tax":0,"timeframe":"weekly"}],"LEGAL / ACCOUNTING":[{"Accounting":0,"Incl. Tax":0,"timeframe":"weekly"},{"Accounting & CRM Software":0,"Incl. Tax":0,"timeframe":"weekly"},{"Business Registration":0,"Incl. Tax":0,"timeframe":"weekly"},{"Health Insurance":0,"Incl. Tax":0,"timeframe":"weekly"},{"Legal":0,"Incl. Tax":0,"timeframe":"weekly"},{"Liability Insurance":0,"Incl. Tax":0,"timeframe":"weekly"},{"Proffesionals Other":0,"Incl. Tax":0,"timeframe":"weekly"},{"Public Laibiliy & Insurance":0,"Incl. Tax":0,"timeframe":"weekly"},{"Other":0,"Incl. Tax":0,"timeframe":"weekly"}],"MARKETING":[{"Client gifts and Referral fees":0,"Incl. Tax":0,"timeframe":"weekly"},{"Direct Marketing":0,"Incl. Tax":0,"timeframe":"weekly"},{"Entertainment":0,"Incl. Tax":0,"timeframe":"weekly"},{"Social Media":0,"Incl. Tax":0,"timeframe":"weekly"},{"Web Site Hosting":0,"Incl. Tax":0,"timeframe":"weekly"},{"Web Site Updates & Support":0,"Incl. Tax":0,"timeframe":"weekly"},{"Other":0,"Incl. Tax":0,"timeframe":"weekly"}],"MISCELANEOUS":[{"Apparrel Other":0,"Incl. Tax":0,"timeframe":"weekly"},{"Bank Fees":0,"Incl. Tax":0,"timeframe":"weekly"},{"Depreciation":0,"Incl. Tax":0,"timeframe":"weekly"},{"Living expenses / drawings":0,"Incl. Tax":0,"timeframe":"weekly"},{"Groceries":0,"Incl. Tax":0,"timeframe":"weekly"},{"GST Payments":0,"Incl. Tax":0,"timeframe":"weekly"},{"Hygeine Consumables & Toiletries":0,"Incl. Tax":0,"timeframe":"weekly"},{"Loan Repayments":0,"Incl. Tax":0,"timeframe":"weekly"},{"P.A.Y.E":0,"Incl. Tax":0,"timeframe":"weekly"},{"Salaries / Wages /":0,"Incl. Tax":0,"timeframe":"weekly"},{"Uniforms":0,"Incl. Tax":0,"timeframe":"weekly"},{"Other":0,"Incl. Tax":0,"timeframe":"weekly"}],"OFFICE":[{"Computers":0,"Incl. Tax":0,"timeframe":"weekly"},{"Furniture maintenance":0,"Incl. Tax":0,"timeframe":"weekly"},{"Insurance":0,"Incl. Tax":0,"timeframe":"weekly"},{"Office Chairs & Desk maintenance":0,"Incl. Tax":0,"timeframe":"weekly"},{"Postage & PO Box rentals":0,"Incl. Tax":0,"timeframe":"weekly"},{"Other":0,"Incl. Tax":0,"timeframe":"weekly"}],"PREMISES":[{"Electricity":0,"Incl. Tax":0,"timeframe":"weekly"},{"Insurance":0,"Incl. Tax":0,"timeframe":"weekly"},{"Rates":0,"Incl. Tax":0,"timeframe":"weekly"},{"Rent / Mortgage":0,"Incl. Tax":0,"timeframe":"weekly"},{"Venue maintenance":0,"Incl. Tax":0,"timeframe":"weekly"},{"Water":0,"Incl. Tax":0,"timeframe":"weekly"},{"Other":0,"Incl. Tax":0,"timeframe":"weekly"}],"STATIONARY":[{"Business Cards":0,"Incl. Tax":0,"timeframe":"weekly"},{"Flyers":0,"Incl. Tax":0,"timeframe":"weekly"},{"Gifts & Vouchers":0,"Incl. Tax":0,"timeframe":"weekly"},{"Letterheads":0,"Incl. Tax":0,"timeframe":"weekly"},{"Logo Design":0,"Incl. Tax":0,"timeframe":"weekly"},{"Printing":0,"Incl. Tax":0,"timeframe":"weekly"},{"Other":0,"Incl. Tax":0,"timeframe":"weekly"}],"TRAINING":[{"Conferences":0,"Incl. Tax":0,"timeframe":"weekly"},{"Continued Education":0,"Incl. Tax":0,"timeframe":"weekly"},{"Memberships & Registration Fees":0,"Incl. Tax":0,"timeframe":"weekly"},{"Workshops & Courses":0,"Incl. Tax":0,"timeframe":"weekly"},{"Other":0,"Incl. Tax":0,"timeframe":"weekly"}],"VEHICLE":[{"Bus / Train Fares":0,"Incl. Tax":0,"timeframe":"weekly"},{"Fuel":0,"Incl. Tax":0,"timeframe":"weekly"},{"Parking":0,"Incl. Tax":0,"timeframe":"weekly"},{"Registration":0,"Incl. Tax":0,"timeframe":"weekly"},{"Service / Repairs":0,"Incl. Tax":0,"timeframe":"weekly"},{"Vehicle Repayments":0,"Incl. Tax":0,"timeframe":"weekly"},{"WOF":0,"Incl. Tax":0,"timeframe":"weekly"},{"Other":0,"Incl. Tax":0,"timeframe":"weekly"}]};
    var businesObject = {"COMMUNICATION":[{"Internet":0,"Incl. Tax":1,"timeframe":timeframe},{"Landline":0,"Incl. Tax":1,"timeframe":timeframe},{"Mobile":0,"Incl. Tax":1,"timeframe":timeframe},{"Modem / Router":0,"Incl. Tax":1,"timeframe":timeframe},{"Other":0,"Incl. Tax":1,"timeframe":timeframe}],"LEGAL / ACCOUNTING":[{"Accounting":0,"Incl. Tax":1,"timeframe":timeframe},{"Accounting & CRM Software":0,"Incl. Tax":1,"timeframe":timeframe},{"Business Registration":0,"Incl. Tax":1,"timeframe":timeframe},{"Health Insurance":0,"Incl. Tax":1,"timeframe":timeframe},{"Legal":0,"Incl. Tax":1,"timeframe":timeframe},{"Liability Insurance":0,"Incl. Tax":1,"timeframe":timeframe},{"Proffesionals Other":0,"Incl. Tax":1,"timeframe":timeframe},{"Public Laibiliy & Insurance":0,"Incl. Tax":1,"timeframe":timeframe},{"Other":0,"Incl. Tax":1,"timeframe":timeframe}],"MARKETING":[{"Client gifts and Referral fees":0,"Incl. Tax":1,"timeframe":timeframe},{"Direct Marketing":0,"Incl. Tax":1,"timeframe":timeframe},{"Entertainment":0,"Incl. Tax":1,"timeframe":timeframe},{"Social Media":0,"Incl. Tax":1,"timeframe":timeframe},{"Web Site Hosting":0,"Incl. Tax":1,"timeframe":timeframe},{"Web Site Updates & Support":0,"Incl. Tax":1,"timeframe":timeframe},{"Other":0,"Incl. Tax":1,"timeframe":timeframe}],"MISCELANEOUS":[{"Apparrel Other":0,"Incl. Tax":1,"timeframe":timeframe},{"Bank Fees":0,"Incl. Tax":1,"timeframe":timeframe},{"Depreciation":0,"Incl. Tax":1,"timeframe":timeframe},{"Living expenses / drawings":0,"Incl. Tax":1,"timeframe":timeframe},{"Groceries":0,"Incl. Tax":1,"timeframe":timeframe},{"GST Payments":0,"Incl. Tax":1,"timeframe":timeframe},{"Hygeine Consumables & Toiletries":0,"Incl. Tax":1,"timeframe":timeframe},{"Loan Repayments":0,"Incl. Tax":1,"timeframe":timeframe},{"P.A.Y.E":0,"Incl. Tax":1,"timeframe":timeframe},{"Salaries / Wages /":0,"Incl. Tax":1,"timeframe":timeframe},{"Uniforms":0,"Incl. Tax":1,"timeframe":timeframe},{"Other":0,"Incl. Tax":1,"timeframe":timeframe}],"OFFICE":[{"Computers":0,"Incl. Tax":1,"timeframe":timeframe},{"Furniture maintenance":0,"Incl. Tax":1,"timeframe":timeframe},{"Insurance":0,"Incl. Tax":1,"timeframe":timeframe},{"Office Chairs & Desk maintenance":0,"Incl. Tax":1,"timeframe":timeframe},{"Postage & PO Box rentals":0,"Incl. Tax":1,"timeframe":timeframe},{"Other":0,"Incl. Tax":1,"timeframe":timeframe}],"PREMISES":[{"Electricity":0,"Incl. Tax":1,"timeframe":timeframe},{"Insurance":0,"Incl. Tax":1,"timeframe":timeframe},{"Rates":0,"Incl. Tax":1,"timeframe":timeframe},{"Rent / Mortgage":0,"Incl. Tax":1,"timeframe":timeframe},{"Venue maintenance":0,"Incl. Tax":1,"timeframe":timeframe},{"Water":0,"Incl. Tax":1,"timeframe":timeframe},{"Other":0,"Incl. Tax":1,"timeframe":timeframe}],"STATIONARY":[{"Business Cards":0,"Incl. Tax":1,"timeframe":timeframe},{"Flyers":0,"Incl. Tax":1,"timeframe":timeframe},{"Gifts & Vouchers":0,"Incl. Tax":1,"timeframe":timeframe},{"Letterheads":0,"Incl. Tax":1,"timeframe":timeframe},{"Logo Design":0,"Incl. Tax":1,"timeframe":timeframe},{"Printing":0,"Incl. Tax":1,"timeframe":timeframe},{"Other":0,"Incl. Tax":1,"timeframe":timeframe}],"TRAINING":[{"Conferences":0,"Incl. Tax":1,"timeframe":timeframe},{"Continued Education":0,"Incl. Tax":1,"timeframe":timeframe},{"Memberships & Registration Fees":0,"Incl. Tax":1,"timeframe":timeframe},{"Workshops & Courses":0,"Incl. Tax":1,"timeframe":timeframe},{"Other":0,"Incl. Tax":1,"timeframe":timeframe}],"VEHICLE":[{"Bus / Train Fares":0,"Incl. Tax":1,"timeframe":timeframe},{"Fuel":0,"Incl. Tax":1,"timeframe":timeframe},{"Parking":0,"Incl. Tax":1,"timeframe":timeframe},{"Registration":0,"Incl. Tax":1,"timeframe":timeframe},{"Service / Repairs":0,"Incl. Tax":1,"timeframe":timeframe},{"Vehicle Repayments":0,"Incl. Tax":1,"timeframe":timeframe},{"WOF":0,"Incl. Tax":1,"timeframe":timeframe},{"Other":0,"Incl. Tax":1,"timeframe":timeframe}]};
    ...
    renderDefaultDataToModal('business_expenses',businesObject);
        ...
        $(document).on('click','.business_expense_submit',function(){
          ...
          var finalVal = 0;
              ...
              var businessInclTax = "Incl. Tax";
               ...
               if (BusinessStorage.hasOwnProperty(businessPID)){
                   ...
                   for (i = 0; i < BusinessStorage[businessPID].length; i++) {
                       if (BusinessStorage[businessPID] && BusinessStorage[businessPID][i].hasOwnProperty(businessCHKID)) {
                           BusinessStorage[businessPID][i][businessINPUTID] = businessINTPUTVAL;
                           var temp = timeframeCalculation(BusinessStorage[businessPID][i][businessCHKID] , BusinessStorage[businessPID][i][businessINPUTID] , 'business_expenses' , BusinessStorage[businessPID][i][businessInclTax]);
           ...
           // var business_exp_gst_incl = finalVal;
           // var business_exp_gst_excl = 0;
           // var gst_tax = 0;
          ...
          console.log(finalVal ,'before gst finval');
           ...
           $('.business_fill_data').each(function(){
              ...
              be_calculated += parseFloat($(this).val());
          });
          finalVal += gst_tax; // Adding GST Tax

          console.log(finalVal ,'finalVal afetr GST');
          
          if($('#is_gst_registered').val() == 1){ // IF GST IS YES 
            var countGst = (parseFloat($('.gst-percentage').val()) + 100) / 100;
            be_gst_excl += parseFloat(finalVal) / countGst;
            be_gst_paid += parseFloat(finalVal) - parseFloat(be_gst_excl); 
          } 

          console.log(be_gst_excl ,'be_gst_excl');

          console.log(finalVal , 'finalVal');

          $('#be_calculated').val((finalVal).toFixed(2)); 
          $('#be_gst_excl').val((be_gst_excl).toFixed(2));
          $('#be_gst_paid').val((be_gst_paid).toFixed(2));

          $('#be_calculated').trigger('blur');
        ...
        $(document).on('click', '.add_new_business_field_btn', function () {
            ...
            ContentsArray[selectedSection].push({ [inputLable] : 0 , "Incl. Tax" : 1, "timeframe" : timeframe });
        ...
        function rendorBusinessJSONObejct(JsonObj) {
            ...
            var fields = '';
                ...
                for (var j=0;j<$FieldKeys.length ; j++) {
                   var fieldVal = 0;
                   var checkboxVal = 0;
                   var gstIncl = 'false' , timeframeBoxVal = setting_pref_timeframe;
                    var is_check = 'checked';
                   var $inputFieldKeys = Object.keys(JsonObj[$keys[i]][$FieldKeys[j]]);
                    for (var k = 0; k < $inputFieldKeys.length; k++) {
                      if (JsonObj[$keys[i]][$FieldKeys[j]][$inputFieldKeys[0]]){
                    ...
                    // Auto Populate
                      if($inputFieldKeys[0] == 'Living expenses / drawings')
                      {
                        var fieldVal = $('#le_calculated').val();
                      } else {
                      }
                    // End Auto Populate
                    ...
                    else if (timeframeBoxVal == 'annually') 
                    {
                    ...
                    var chkBox = '<div class="checkbox clip-check check-primary checkbox-inline m-b-0"><input data-business-parent-id="'+$keys[i]+
                       '"'+is_check+' data-business-check-id="'+$inputFieldKeys[0]+'" id="checkbox" type="checkbox" value="1" class="chk" name="Incl. Tax"><label for="checkbox'+$FieldKeys[j]+'"></label></div>';
                    ...
                    var timeframeBox = '<select data-business-parent-id="'+$keys[i]+'" data-business-timeframe-id="'+$inputFieldKeys[0]+'" name="timeframe" class="timeframe form-control">' +
                     ...
                     fields +='<tr class="dynamic_input_box" style="width: 100%;">' +
                       ...
                       ''+chkBox+'</td>' + '<td class="w-20 timeframe-td"> '+timeframeBox+' </td>' +
                        ...
                        'role="button" value="Small Default" data-business-parent-id="'+$keys[i]+
                        '"title="Edit field" data-business-field-id="'+$inputFieldKeys[0]+'">' + 
                        '<i class="fa fa-pencil" style="color:#ff4401;"></i></a></strong>' +
                        '</td></tr>';
                }
                fields += '</tbody></table>';
...
/* * * * * * * * * * * * * start living expenses  * * * * * * * * * * * * */
    ...
    var livinObject =  {"COMMUNICATION":[{"Internet":0,"Incl. Tax":1,"timeframe":timeframe},{"Landline":0,"Incl. Tax":1,"timeframe":timeframe},{"Mobile":0,"Incl. Tax":1,"timeframe":timeframe},{"Other":0,"Incl. Tax":1,"timeframe":timeframe}],"GENERAL & MISCELANEOUS":[{"Groceries":0,"Incl. Tax":1,"timeframe":timeframe},{"Loan Repayments":0,"Incl. Tax":1,"timeframe":timeframe},{"Other":0,"Incl. Tax":1,"timeframe":timeframe}],"PERSONAL":[{"Clothing":0,"Incl. Tax":1,"timeframe":timeframe},{"Entertainment":0,"Incl. Tax":1,"timeframe":timeframe},{"Gifts":0,"Incl. Tax":1,"timeframe":timeframe},{"Haircuts":0,"Incl. Tax":1,"timeframe":timeframe},{"Health Insurance":0,"Incl. Tax":1,"timeframe":timeframe},{"Massage":0,"Incl. Tax":1,"timeframe":timeframe},{"Memberships":0,"Incl. Tax":1,"timeframe":timeframe},{"Savings":0,"Incl. Tax":1,"timeframe":timeframe},{"Social":0,"Incl. Tax":1,"timeframe":timeframe},{"Toileteries":0,"Incl. Tax":1,"timeframe":timeframe},{"Other":0,"Incl. Tax":1,"timeframe":timeframe}],"PREMISES":[{"Electricity":0,"Incl. Tax":1,"timeframe":timeframe},{"Insurance":0,"Incl. Tax":1,"timeframe":timeframe},{"Rates":0,"Incl. Tax":1,"timeframe":timeframe},{"Rent / Mortgage":0,"Incl. Tax":1,"timeframe":timeframe},{"TV Subscription":0,"Incl. Tax":1,"timeframe":timeframe},{"Water":0,"Incl. Tax":1,"timeframe":timeframe},{"Other":0,"Incl. Tax":1,"timeframe":timeframe}],"VEHICLE":[{"Bus / Train Fares":0,"Incl. Tax":1,"timeframe":timeframe},{"Fuel":0,"Incl. Tax":1,"timeframe":timeframe},{"Parking":0,"Incl. Tax":1,"timeframe":timeframe},{"Registration":0,"Incl. Tax":1,"timeframe":timeframe},{"Service / Repairs":0,"Incl. Tax":1,"timeframe":timeframe},{"Vehicle Repayments":0,"Incl. Tax":1,"timeframe":timeframe},{"WOF":0,"Incl. Tax":1,"timeframe":timeframe},{"Other":0,"Incl. Tax":1,"timeframe":timeframe}]};  
    ...
    renderDefaultDataToModal('living_expenses',livinObject);
          ...
          $('.timeframe').each(function(){
              ...
              if (LivingStorage.hasOwnProperty(livingPID)){
                  for (i = 0; i < LivingStorage[livingPID].length; i++) {
                      if (LivingStorage[livingPID] && LivingStorage[livingPID][i].hasOwnProperty(livingCHKID)) {
                          LivingStorage[livingPID][i][livingINPUTID] = livingINTPUTVAL;
                           var temp = timeframeCalculation(LivingStorage[livingPID][i][livingCHKID] , LivingStorage[livingPID][i][livingINPUTID] ,'living_expenses');
                           finalVal += parseFloat(temp);
                      }
                  }
              }
           ...
           if(!$(this).val()){
            ...
            $('#le_calculated').val((finalVal).toFixed(2));
            $('#le_calculated').trigger('change');
              if(living_exp_gst_incl != null && living_exp_gst_incl != 0) {
              
              var countGst = (parseFloat($('.gst-percentage').val()) + 100) / 100;
              living_exp_gst_excl += parseFloat(living_exp_gst_incl) / countGst;
                $('#le_gst_excl').val((living_exp_gst_excl).toFixed(2));

              }else {
                $('#le_gst_excl').val((living_exp_gst_excl).toFixed(2));
              }

            var le_gst_paid  = parseFloat(living_exp_gst_incl) - parseFloat(living_exp_gst_excl);
            $('#le_gst_paid').val((le_gst_paid).toFixed(2));
        });
                ...
                for (var j=0;j<$FieldKeys.length ; j++) {
                   ...
                   var $inputFieldKeys = Object.keys(JsonObj[$keys[i]][$FieldKeys[j]]);
                    ...
                    var chkBox = '<div class="checkbox clip-check check-primary checkbox-inline m-b-0 businesschk"><input data-living-parent-id="'+$keys[i]+
                       '"'+is_check+' data-living-check-id="'+$inputFieldKeys[0]+'" id="checkbox" type="checkbox" value="1" class="chk" name="Incl. Tax" disabled><label class="living-lbl" for="checkbox'+$FieldKeys[j]+'"></label></div>';
                   ...
                   var timeframeBox = '<select data-living-parent-id="'+$keys[i]+'" data-living-timeframe-id="'+$inputFieldKeys[0]+'" name="timeframe" class="timeframe form-control">' +
                    ...
                    fields +='<tr class="dynamic_input_box" style="width: 100%;">' +
                       ...
                       ''+chkBox+'</td>' + '<td class="w-20 timeframe-td"> '+timeframeBox+' </td>' +
                        ...
                        'role="button" value="Small Default" data-living-parent-id="'+$keys[i]+
                        '"title="Edit field" data-living-field-id="'+$inputFieldKeys[0]+'">' +
                        '<i class="fa fa-pencil" style="color:#ff4401;"></i></a></strong>' +
                        '</td></tr>';
                }
                fields += '</tbody></table>';
        ...
        $('.living-lbl').click(false); // To disable checkbox click

/* * * * * * * * * * * * * end living expenses  * * * * * * * * * * * * */


/* * * * * * * * * * * * * start partnership expenses  * * * * * * * * * * * * */
    var timeframe = "weekly";
    if(setting_pref_timeframe != null)
    {
      var timeframe = setting_pref_timeframe;
    }                    
    var partnershipObject = {
                        "Premises":[{"Rent":0,"Incl. Tax":1, "timeframe" : timeframe },{"Mortgage / Insurance":0,"Incl. Tax":1, "timeframe" : timeframe},{"Power":0,"Incl. Tax":1, "timeframe" : timeframe},{"Rates":0,"Incl. Tax":1, "timeframe" : timeframe}],
                        "Communication":[{"Landline":0,"Incl. Tax":1, "timeframe" : timeframe},{"Mobile":0,"Incl. Tax":1, "timeframe" : timeframe},{"Internet":0,"Incl. Tax":1, "timeframe" : timeframe}],
                        "Vehicle / Travel":[{"Car repayments":0,"Incl. Tax":1, "timeframe" : timeframe},{"Petrol":0,"Incl. Tax":1, "timeframe" : timeframe},{"Mileage":0,"Incl. Tax":1, "timeframe" : timeframe},{"WOF":0,"Incl. Tax":1, "timeframe" : timeframe},{"Rego":0,"Incl. Tax":1, "timeframe" : timeframe},{"Car service / Repairs":0,"Incl. Tax":1, "timeframe" : timeframe},{"Parking":0,"Incl. Tax":1, "timeframe" : timeframe},{"Bus / Train fares":0,"Incl. Tax":1, "timeframe" : timeframe}],
                        "Office & Stationary":[{"Furniture":0,"Incl. Tax":1, "timeframe" : timeframe},{"Insurance":0,"Incl. Tax":1, "timeframe" : timeframe},{"Maintenance":0,"Incl. Tax":1, "timeframe" : timeframe},{"Postage & PO Box rental":0,"Incl. Tax":1, "timeframe" : timeframe},{"Printing":0,"Incl. Tax":1, "timeframe" : timeframe},{"Staff salaries":0,"Incl. Tax":1, "timeframe" : timeframe}],
                        "Marketing":[{"Website hosting":0,"Incl. Tax":1, "timeframe" : timeframe},{"Advertising":0,"Incl. Tax":1, "timeframe" : timeframe},{"Entertainment":0,"Incl. Tax":1, "timeframe" : timeframe}],
                        "Training":[{"Workshops / Courses":0,"Incl. Tax":1, "timeframe" : timeframe},{"Professional Memberships":0,"Incl. Tax":1, "timeframe" : timeframe},{"Conferences":0,"Incl. Tax":1, "timeframe" : timeframe}],
                        "Legal / Accounting":[{"Accountant fees":0,"Incl. Tax":1, "timeframe" : timeframe},{"Other professionals":0,"Incl. Tax":1, "timeframe" : timeframe},{"Taxes":0,"Incl. Tax":1, "timeframe" : timeframe}],
                        "Misc Costs":[{"Debt":0,"Incl. Tax":1, "timeframe" : timeframe},{"Bank fees":0,"Incl. Tax":1, "timeframe" : timeframe},{"Depreciation":0,"Incl. Tax":1, "timeframe" : timeframe},{"Drawings":0,"Incl. Tax":1, "timeframe" : timeframe}]};

    renderDefaultDataToModal('partnership_expenses',partnershipObject);

        $(document).on('click','.partnership_expense_submit',function(){
        
           $('.chk').each(function(){
              var partnershipStorage = JSON.parse(localStorage.getItem('partnership_expenses'));
              var partnershipPID = $(this).attr('data-partnership-parent-id');
               var partnershipCHKID = $(this).attr('data-partnership-check-id');
              var partnershipINPUTID = "Incl. Tax";
              var partnershipINTPUTVAL = $(this).val();

               if (partnershipStorage.hasOwnProperty(partnershipPID)){
                   for (i = 0; i < partnershipStorage[partnershipPID].length; i++) {
                       if (partnershipStorage[partnershipPID] && partnershipStorage[partnershipPID][i].hasOwnProperty(partnershipCHKID)) {
                           partnershipStorage[partnershipPID][i][partnershipINPUTID] = partnershipINTPUTVAL;
                       }
                   }
               }
             localStorage.setItem('partnership_expenses', JSON.stringify(partnershipStorage));
           });
           ...
           $('.timeframe').each(function(){
              var partnershipStorage = JSON.parse(localStorage.getItem('partnership_expenses'));
              var partnershipPID = $(this).attr('data-partnership-parent-id');
               var partnershipCHKID = $(this).attr('data-partnership-timeframe-id');
              var partnershipINPUTID = "timeframe";
              var partnershipINTPUTVAL = $(this).val();
               ...
               if (partnershipStorage.hasOwnProperty(partnershipPID)){
                   for (i = 0; i < partnershipStorage[partnershipPID].length; i++) {
                       if (partnershipStorage[partnershipPID] && partnershipStorage[partnershipPID][i].hasOwnProperty(partnershipCHKID)) {
                           partnershipStorage[partnershipPID][i][partnershipINPUTID] = partnershipINTPUTVAL;
                           var temp = timeframeCalculation(partnershipStorage[partnershipPID][i][partnershipCHKID] , partnershipStorage[partnershipPID][i][partnershipINPUTID] ,'living_expenses');
                           finalVal += parseFloat(temp);
                       }
                   }
               }
           ...
           var partnership_amount_sum = 0;
           var partnership_exp_gst_incl = 0;
           var partnership_exp_gst_excl = 0;
           $('.partnership_fill_data').each(function(){
           if(!$(this).val()){
              $(this).val() = 0;
           }
            if($(this).attr('gst-incl') == 'true'){
             partnership_exp_gst_incl += parseFloat($(this).val());
            }
            partnership_amount_sum += parseFloat($(this).val());
           });

           console.log(partnership_amount_sum ,'partnership_amount_sum');
           console.log(finalVal,'on partner submit : finalVal');
           console.log(partnership_exp_gst_incl,'on partner submit : partnership_exp_gst_incl');

            var no_of_partner = $('#no_of_partner').val();

           // console.log(no_of_partner,'on partner submit : no_of_partner');
           calculateAllPartners(no_of_partner ,finalVal , finalVal , modal = 'partnership');
           // calculateAllPartners(no_of_partner ,finalVal , partnership_exp_gst_incl , modal = 'partnership');


           // $('.invested_amount').first().val((partnership_amount_sum).toFixed(2));
           // var firstPercentage = $('.equity_ratio').first().val();
           //  if(partnership_exp_gst_incl > 0) {
           //    partnership_exp_gst_excl += (parseFloat(partnership_exp_gst_incl) / 100) * firstPercentage;
           //  }
           //  $('.gst_excl').first().val((partnership_exp_gst_excl).toFixed(2));
           //  var gst_paid =  partnership_amount_sum -  partnership_exp_gst_excl;
           //  $('.gst_paid').first().val((gst_paid).toFixed(2));
            // Other Partner Calculation
            // var estimate = partnership_exp_gst_incl;
            // var no_of_partner = $('#no_of_partner').val();
            ...
            // Function To calucate all estimate , gst excl , gst paid Fields
            ...
            //     var k = i - 1;
            //     var first_percentage = $('#equity_ratio_'+k+'').val();
            ...
            //     var gst_paid = invested_amount - excl;
        ...
        //  CRUD ~~~~~
        //  on change event input fill
        $(document).on('keyup change','.partnership_fill_data',function(){
            var partnershipStorage = JSON.parse(localStorage.getItem('partnership_expenses'));
            var partnershipPID = $(this).attr('data-partnership-parent-id');
            var partnershipINPUTID = $(this).attr('data-partnership-input-id');
            var partnershipINTPUTVAL = $(this).val();
            $(this).val(partnershipINTPUTVAL);
            if (partnershipStorage.hasOwnProperty(partnershipPID)) {
                if (partnershipStorage[partnershipPID]){
                    for (i = 0; i < partnershipStorage[partnershipPID].length; i++) { 
                      console.log(partnershipStorage[partnershipPID][i].hasOwnProperty(partnershipINPUTID))
                        if (partnershipStorage[partnershipPID] && partnershipStorage[partnershipPID][i].hasOwnProperty(partnershipINPUTID)) {
                            partnershipStorage[partnershipPID][i][partnershipINPUTID] = partnershipINTPUTVAL;
                        }
                    }
                }
                // if (partnershipStorage[partnershipPID] && partnershipStorage[partnershipPID].hasOwnProperty(partnershipINPUTID)){
                //     partnershipStorage[partnershipPID][partnershipINPUTID] = partnershipINTPUTVAL;
                // }
            }
            localStorage.setItem('partnership_expenses', JSON.stringify(partnershipStorage));
        });
        ...
        // add section
        var partnershipJSONObejct = {};
        $(document).on('click','#add-partnership-section',function(){
            if (localStorage.getItem('partnership_expenses')){
                partnershipJSONObejct = JSON.parse(localStorage.getItem('partnership_expenses')); // add previous data as it is
                partnershipJSONObejct[$('.partnership_section_name').val()] = []; // add new section
            }
            partnershipJSONObejct[$('.partnership_section_name').val()] = []; // add new section
            rendorpartnershipJSONObejct(partnershipJSONObejct);
            localStorage.setItem('partnership_expenses',JSON.stringify(partnershipJSONObejct));
        });
        $(document).on('click','.add_new_partnership_input_btn',function(){
            $('.add_new_partnership_field_btn').removeProp('data-section-partnership-id');
            $('.add_new_partnership_field_btn').attr('data-section-partnership-id',$(this).attr('data-section-partnership-id'));
        });

        // delete section
        $(document).on('click', '.delete_partnership_section_btn', function () {
            var localData = JSON.parse(localStorage.getItem('partnership_expenses'));
            var dId= $(this).attr('data-partnership-section-id');

            if (localData.hasOwnProperty(dId)){
                delete localData[dId];
                console.log('deleted successfuly!');
            }
            localStorage.setItem('partnership_expenses', JSON.stringify(localData));
            $(this).parent().parent().remove();
        });

        // add field
        $(document).on('click', '.add_new_partnership_field_btn', function () {
            var ContentsArray = JSON.parse(localStorage.getItem('partnership_expenses'));
            var inputLable = $('.partnership_field_name').val();
            var selectedSection = $(this).attr('data-section-partnership-id');
            ContentsArray[selectedSection].push({ [inputLable] : 0 , "Incl. Tax" : 1, "timeframe" : timeframe });
            // if (ContentsArray.hasOwnProperty(selectedSection)) {
            //     ContentsArray[selectedSection][inputLable] = 0;
            // }
            localStorage.setItem('partnership_expenses', JSON.stringify(ContentsArray));
            var tempArray = JSON.parse(localStorage.getItem('partnership_expenses'));
            rendorpartnershipJSONObejct(tempArray);
            $('.timeframe').selectpicker('refresh');
        });

        // delete field
        $(document).on('click', '.remove_partnership_section_field_btn', function () {
            var LocalStorageData = JSON.parse(localStorage.getItem('partnership_expenses'));
            var selectForDelete = $(this).attr('data-partnership-field-id');
            var selectedParentId = $(this).attr('data-partnership-parent-id');
            if (LocalStorageData.hasOwnProperty(selectedParentId)) {
                if (LocalStorageData[selectedParentId]){
                    for (i = 0; i < LocalStorageData[selectedParentId].length; i++) {
                        if (LocalStorageData[selectedParentId] && LocalStorageData[selectedParentId][i].hasOwnProperty(selectForDelete)) {
            ...
            localStorage.setItem('partnership_expenses', JSON.stringify(LocalStorageData));
            $(this).parent().parent().remove();
        });

        // render json object to html
        function rendorpartnershipJSONObejct(JsonObj) {
            var partnership_contents = '';
            partnership_contents +='<div class="partnership-section">';
            ...
            var fields = '';
                ...
                for (var j=0;j<$FieldKeys.length ; j++) {
                   ...
                   var $inputFieldKeys = Object.keys(JsonObj[$keys[i]][$FieldKeys[j]]);
                    ...
                    var chkBox = '<div class="checkbox clip-check check-primary checkbox-inline m-b-0"><input data-partnership-parent-id="'+$keys[i]+
                       '"'+is_check+' data-partnership-check-id="'+$inputFieldKeys[0]+'" id="checkbox" type="checkbox" value="'+ checkboxVal +'" class="chk" name="Incl. Tax" disabled><label class="partner-chk-lbl" for="checkbox'+$FieldKeys[j]+'"></label></div>';

                    var timeframeBox = '<select data-partnership-parent-id="'+$keys[i]+'" data-partnership-timeframe-id="'+$inputFieldKeys[0]+'" name="timeframe" class="timeframe form-control">' +
                                      '<option value="" disabled>Select Timeframe</option>' +
                                      '<option value="weekly" '+weekly_selected+'>Weekly</option>' +
                                      '<option value="fortnightly" '+fortnightly_selected+'>Fortnightly</option>' +
                                      '<option value="monthly" '+monthly_selected+'>Monthly</option>' +
                                      '<option value="annually" '+annually_selected+'>Annually</option></select>';   
                     fields +='<tr class="dynamic_input_box" style="width: 100%;">' +
                         '<td class="partnership input_name w-20 text-left" data-id="'+j+'" data-partnership-parent-id="'+$keys[i]+'" data-partnership-input-id="'+$inputFieldKeys[0]+'">'+
                        $inputFieldKeys[0]+'</td><td class="w-20 input_value"><input gst-incl="' + gstIncl +'" class="form-control input_field_value allowNumericWithDecimalOnly' +
                        ' partnership_fill_data" data-partnership-parent-id="'+$keys[i]+'" data-partnership-input-id="'+$inputFieldKeys[0]+'"' +
                        ' placeholder="$11,200.00" type="text" value="'+fieldVal+'"></td>' +
                        '<td class="w-20">' + 'Inc. GST? &nbsp;' +
                       ''+chkBox+'</td>' + '<td class="w-20 timeframe-td"> '+timeframeBox+' </td>' +
                        '<td class="w-10"><a style="margin-right: 1px;margin-bottom: 3px;" class="btn btn-xs btn-default tooltips pull-right remove_partnership_section_field_btn"' +
                        'role="button" value="Small Default" data-partnership-parent-id="'+$keys[i]+
                        '"title="Remove field" data-partnership-field-id="'+$inputFieldKeys[0]+'">' +
                        '<i class="fa fa-trash" style="color:#ff4401;"></i></a></strong>' +
                        '<a style="margin-right: 1px;margin-bottom: 3px;" class="btn btn-xs btn-default tooltips pull-right partnership edit_partnership_section_field_btn"' +
                        'role="button" value="Small Default" data-partnership-parent-id="'+$keys[i]+
                        '"title="Edit field" data-partnership-field-id="'+$inputFieldKeys[0]+'">' + 
                        '<i class="fa fa-pencil" style="color:#ff4401;"></i></a></strong>' +
                        '</td></tr>';
                }
                fields += '</tbody></table>';

                partnership_contents +=  '<div class="partnership-dynamic-section"><strong class="dynamic_title" data-title="'+$keys[i]+'">' + $keys[i] +
                    '<a style="margin-right: 1px;margin-bottom: 3px;" class="btn btn-xs btn-default tooltips p-y-0 pull-right delete_partnership_section_btn"' +
                    'role="button" value="Small Default" title="Remove section" data-partnership-section-id="'+$keys[i]+'">' +
                    '<i class="fa fa-trash" style="color:#ff4401;"></i></a>' +
                    '<a style="margin-right: 1px;margin-bottom: 3px;" class="btn btn-xs btn-default tooltips p-y-0 pull-right partnership edit_partnership_section_btn"' +
                   'role="button" value="Small Default" title="Edit section" data-partnership-section-id="'+$keys[i]+'">' +
                   '<i class="fa fa-pencil" style="color:#ff4401;"></i></a>' +
                    '<a style="margin-right: 1px;margin-bottom: 3px;" class="btn btn-xs btn-default tooltips p-y-0 pull-right add_new_partnership_input_btn"' +
                     'data-toggle="modal" href="#partnership-field-modal" data-section-partnership-id="'+$keys[i]+
                     '"role="button" value="Small Default" title="Add new field">' +
                     '<i class="fa fa-plus-circle" style="color:#ff4401;"></i></a></strong>' +
                    '<div class="responsive-table"><div class="scrollable-area">' +
                    '<table class="table data-table table table-bordered table-striped"><tbody>' +fields+
                    '</div></div></div></tbody></table>';
                partnership_contents +='<br>';
            }
            partnership_contents +='</div>';
            // add to html
            $('.partnership-expense-content').html(partnership_contents);
        ...
        // previous code...
        $('.overflow').click(function(){
            $('#partnership-modal').css('overflow-y','auto','important');
        });

        $('.partner-chk-lbl').click(false);

/* * * * * * * * * * * * * end partnership expenses  * * * * * * * * * * * * */



/* * * * * * * * * * * * * Editable Labels  * * * * * * * * * * * * */

 $(document).on("click", ".edit_setup_section_field_btn , .edit_business_section_field_btn, .edit_living_section_field_btn, .edit_partnership_section_field_btn", function (evt) {
     if ($(this).hasClass('living')){
         ...
         var $targetLabel = $(this).closest('.dynamic_input_box').find('.input_name');
         var txt = $targetLabel.text();
         var parentId = $targetLabel.attr('data-partnership-parent-id');
         var inputId = $targetLabel.attr('data-partnership-input-id');
         var index = $targetLabel.attr('data-id');
         $targetLabel.replaceWith("<input type='text' class='input_name partnership' data-id='"+index+"' data-partnership-input-id='"+inputId+"' data-partnership-parent-id='"+parentId+"'>");
     }else{
         evt.preventDefault();
         var $targetLabel = $(this).closest('.dynamic_input_box').find('.input_name');
         var txt = $targetLabel.text();
  ...
  $(document).on("blur", "input.input_name", function (evt) {
      ...
      if ($(this).hasClass('living')){
          ...
          var setupPID = $(this).attr('data-partnership-parent-id');
          var setupINPUTID = $(this).attr('data-partnership-input-id');
          var setupINTPUTVAL = $(this).val();
          $(this).val(setupINTPUTVAL);
          $(this).closest('.dynamic_input_box').find('.input_value input').attr('data-partnership-input-id', setupINTPUTVAL);
          $(this).closest('.dynamic_input_box').find('a.remove_setup_section_field_btn').attr('data-partnership-input-id', setupINTPUTVAL);
          $(this).closest('.dynamic_input_box').find('.checkbox .chk').attr('data-partnership-input-id', setupINTPUTVAL);

          // evt.preventDefault();
          var $targetInput = $(evt.target).closest('input.input_name');
          var txt = $targetInput.val();
          console.log('txt',txt)
          var parentId = $targetInput.attr('data-partnership-parent-id');
          var inputId = $targetInput.attr('data-partnership-input-id');
          var index = $targetInput.attr('data-id');
          $targetInput.replaceWith("<td class='input_name w-35 text-left' data-id='"+index+"' data-partnership-input-id='"+inputId+"' data-partnership-parent-id='"+parentId+"'> " + txt +"  </td>");
          var SetupStorage = JSON.parse(localStorage.getItem('partnership_expenses'));
          var localstorageKey = 'partnership_expenses';
      ...
      console.log(JSON.stringify(SetupStorage) , '1')
      localStorage.setItem(localstorageKey, JSON.stringify(SetupStorage));
  });

 $(document).on("click", ".edit_setup_section_btn , .edit_business_section_btn, .edit_living_section_btn, .edit_partnership_section_btn", function (evt) {
      if ($(this).hasClass('living')){
        var sectionClassName = 'living';
      } else if($(this).hasClass('business')){
        var sectionClassName = 'business';
      } else if($(this).hasClass('partnership')){
        var sectionClassName = 'partnership';
      } else {
  ...
  $(document).on("blur", "input.input_title", function (evt) {
     ...
     if ($(this).hasClass('living')){
        ...
        var setupINTPUTVAL = $(this).val();
        var oldVal = $(this).attr('data-title');
        $(this).closest('.partnership-dynamic-section').find('.dynamic_input_box').each(function () {
            $(this).find('.input_name').attr('data-partnership-parent-id', setupINTPUTVAL);
            $(this).find('.input_value .partnership_fill_data').attr('data-partnership-parent-id', setupINTPUTVAL);
            $(this).find('a.remove_partnership_section_field_btn').attr('data-partnership-parent-id', setupINTPUTVAL);
            $(this).find('.checkbox .chk').attr('data-partnership-parent-id', setupINTPUTVAL);
        });
        var $targetInput = $(evt.target).closest('input.input_title');
        var txt = $targetInput.val();
        var btns =  '<a style="margin-right: 1px;margin-bottom: 3px;" class="btn btn-xs btn-default tooltips p-y-0 pull-right delete_partnership_section_btn" role="button" value="Small Default" title="Remove section" data-partnership-section-id="Premises"><i class="fa fa-trash" style="color:#ff4401;"></i></a>' +
                    '<a style="margin-right: 1px;margin-bottom: 3px;" class="btn btn-xs btn-default tooltips p-y-0 pull-right partnership edit_partnership_section_btn"' +'role="button" value="Small Default" title="Remove section" data-partnership-section-id="'+setupINTPUTVAL+'">' + '<i class="fa fa-pencil" style="color:#ff4401;"></i></a>' + 
                    '<a style="margin-right: 1px;margin-bottom: 3px;" class="btn btn-xs btn-default tooltips p-y-0 pull-right add_new_partnership_input_btn" data-toggle="modal" href="#partnership-field-modal" data-section-partnership-id="Premises" role="button" value="Small Default" title="Add new field"><i class="fa fa-plus-circle" style="color:#ff4401;"></i></a>';
...
/* * * * * * * * * * * * * Time Frame Calculations  * * * * * * * * * * * * */
  ...
  function timeframeCalculation(fieldVal , timeframeVal , modal = null , isChecked) {
      if(modal == 'business_expenses')
      {
        setting_pref_timeframe = 'monthlyOnly';
      }
      if(modal == 'living_expenses')
      {
        setting_pref_timeframe = 'annualyOnly';
      }

      /** Start : Business Expense Montly **/
      if(setting_pref_timeframe == 'monthlyOnly')
      {
          var temp , weeklyMnth = 4.34524 , fortnightlyMnth = 2.17262 , monthlyMnth = 0 , annuallyMnth = 12;

          if(timeframeVal == 'weekly') // check modal time frame
          {
            temp = fieldVal * weeklyMnth;
          }
          else if (timeframeVal == 'fortnightly')
          {
            temp = fieldVal * fortnightlyMnth
          }
          ...
          {
            temp = fieldVal / annuallyMnth;
          }
          console.log(temp , 'temp');
          return temp;
      }
      /** End : Business Expense Montly **/

      /** Start : Living Expense Annualy **/
      if(setting_pref_timeframe == 'annualyOnly')
      {
          var temp , weeklyAnnual = 52.1429 , fortnightlyAnnual = 26.0714 , monthlyAnnual = 12 , annuallyAnnual = 0;

          if(timeframeVal == 'weekly') // check modal time frame
          {
            temp = fieldVal * weeklyAnnual;
          }
          else if (timeframeVal == 'fortnightly')
          {
            temp = fieldVal * fortnightlyAnnual
          }
          else if (timeframeVal == 'monthly')
          {
            temp = fieldVal * monthlyAnnual;
          }
          else if (timeframeVal == 'annually')
          {
            temp = fieldVal;
      ...
      /** End : Living Expense Annualy **/

      //  WEEKLY
      // setting_pref_timeframe is come from db
...
/* * * * * * * * * * * * * End : Time Frame Calculations  * * * * * * * * * * * * */
  ...
  // function calculateAllPartners(no_of_partner , partnership_exp_gst_incl)
  // {
  //   var no_of_partner = $('#no_of_partner').val();
  //   var equity_ratio_count = $('input[name*="equity_ratio[]"]').length;
  //   var invested_amount_count = $('input[name*="invested_amount[]"]').length;
  ...
  function sortable(JsonObj , $keys)
  {
    var array = [];
    for (var i=0;i<$keys.length ; i++) {
      ...
      for (var j=0;j<$FieldKeys.length ; j++) {
          var $inputFieldKeys = Object.keys(JsonObj[$keys[i]][$FieldKeys[j]]);
          for (var k=0;k<$inputFieldKeys.length ; k++) {
            if($inputFieldKeys[k] != 'Incl. Tax' && $inputFieldKeys[k] != 'timeframe' && $inputFieldKeys[k] != 'Other' && $inputFieldKeys[k] != 'other')
            {
              array.push($inputFieldKeys[k]);
            }
          }
