...
function updateLinkedclientList(clientData){
	...
	var listItem = "<a class='list-group-item"+(isClientDeleted?' list-group-item-warning':'')+"' href='#' data-id='"+clientData['id']+"' data-name='"+clientData['name']+"' data-phone='"+clientData['phone']+"' data-email='"+clientData['email']+"' data-note='"+clientData['note']+"' data-is-reduced-rate='"+clientData['isReducedRate']+"' data-if-recur='"+clientData['ifRecur']+"' data-status='"+clientData['status']+"' data-photo='"+clientData['photo']+"' data-deleted='"+isClientDeleted+"' data-acc-status='"+accStatus+"'>";
	if(clientData['note'])
