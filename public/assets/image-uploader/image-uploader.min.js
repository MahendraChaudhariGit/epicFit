	...
	$.fn.imageUploader = function (options) {
		...
		let createImg = function (src, id, file) {
			...
			$button.on("click", function (e) { 
                console.log('delete==', $(this).attr('filename'));   
                 var image_delete_val = $(this).attr('filename');
                 var html = '<input name="delete_image[]" value='+image_delete_val+'>' ;

                $('.delete-image-value').append(html);
				prevent(e);
