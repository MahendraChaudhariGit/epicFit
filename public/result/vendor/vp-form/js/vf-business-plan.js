...
// controller business plan #2
vfBusinessPlan.controller('BPWidgetTwo', ['$scope', '$rootScope', '$sce', function($scope, $rootScope, $sce) {

    // changes required for new step
    var container = $('.container-bp-step-2');
    // changes required for new step
    ...
    // changes required for new step
    window.getBPS2ActiveIndex = function () {
        return $scope.activeIndex;
    }

    // changes required for new step
    window.digestBPs2 = function () {
        if(!$scope.$$phase) {
            $scope.$digest();
        }
    }
    ...
    // changes required for new step
    window.BPs2Data = $scope.data;
    /* end: DATA **/
}]);



// controller business plan #3
vfBusinessPlan.controller('BPWidgetThree', ['$scope', '$rootScope', '$sce', function($scope, $rootScope, $sce) {

    // changes required for new step
    var container = $('.container-bp-step-3');
    // changes required for new step
    ...
    // changes required for new step
    window.getBPS3ActiveIndex = function () {
        return $scope.activeIndex;
    }

    // changes required for new step
    window.digestBPs3 = function () {
        if(!$scope.$$phase) {
            $scope.$digest();
        }
    }
    ...
    // changes required for new step
    window.BPs3Data = $scope.data;
    /* end: DATA **/
}]);



// controller business plan #4
vfBusinessPlan.controller('BPWidgetFour', ['$scope', '$rootScope', '$sce', function($scope, $rootScope, $sce) {

    // changes required for new step
    var container = $('.container-bp-step-4');
    // changes required for new step
    ...
    // changes required for new step
    window.getBPS4ActiveIndex = function () {
        return $scope.activeIndex;
    }

    // changes required for new step
    window.digestBPs4 = function () {
        if(!$scope.$$phase) {
            $scope.$digest();
        }
    }
    ...
    // changes required for new step
    window.BPs4Data = $scope.data;
    /* end: DATA **/
}]);



// controller business plan #5
vfBusinessPlan.controller('BPWidgetFive', ['$scope', '$rootScope', '$sce', function($scope, $rootScope, $sce) {

    // changes required for new step
    var container = $('.container-bp-step-5');
    // changes required for new step
    ...
    // changes required for new step
    window.getBPS5ActiveIndex = function () {
        return $scope.activeIndex;
    }

    // changes required for new step
    window.digestBPs5 = function () {
        if(!$scope.$$phase) {
            $scope.$digest();
        }
    }
    ...
    // changes required for new step
    window.BPs5Data = $scope.data;
    /* end: DATA **/
}]);



// controller business plan #6
vfBusinessPlan.controller('BPWidgetSix', ['$scope', '$rootScope', '$sce', function($scope, $rootScope, $sce) {

    // changes required for new step
    var container = $('.container-bp-step-6');
    // changes required for new step
    $scope.controllerStep = 6;
    ...
    $scope.activateWindowAdventure = function() {
        // changes required for new step
        $scope.windowAdventure('#viewport-6', '.vp-item', function (viewport, currentItem) {
            var activeIndex = parseInt(jQuery(currentItem).attr('data-index')),
                activeSubIndex = parseInt(jQuery(currentItem).attr('data-sub-index')),
                iType = jQuery(currentItem).attr('data-type');
    ...
    // changes required for new step
    window.getBPS6ActiveIndex = function () {
        return $scope.activeIndex;
    }

    // changes required for new step
    window.digestBPs6 = function () {
        if(!$scope.$$phase) {
            $scope.$digest();
        }
    }
