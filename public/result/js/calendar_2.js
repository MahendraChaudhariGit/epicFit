...
//if modal not showing disable cell click
    ...
    function show_signup_modal_link(class_id)
    {
        calEventdate = '2017-08-22';
        eventId = class_id;
        ...
        {
            toggleWaitShield('show');
            alert(public_url + 'clientevents/classes/' + eventId);
            $.get(public_url + 'clientevents/classes/' + eventId, function (data) {
                toggleWaitShield('hide');
//                console.log('abhi ');
//                console.log(data);
//                return false;
                ...
                alert(moment(data.clientAddedAt).add(24, 'hours').format('YYYY-MM-DD HH:mm:ss'));
