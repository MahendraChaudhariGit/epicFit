    ...
    UI: {
        ...
        addProgramInList: function (p) {
           ...
           // alert("dewdwdwdwdswdsw");
            ...
            .append('<td class="left program_title"><label>' + p.ProgramName + '</label></td>\
				<td class="left exercise_count mob_view"><label>'+ p.Snippet + '</label></td>\<td class="left exercise_count mob_view"><label>qde</label></td>\<td class="left exercise_count mob_view"><label>fc</label></td>\
				<td class=" pull-right">\
