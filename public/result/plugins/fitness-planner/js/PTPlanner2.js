...
jQuery(function ($) {
    ...
    PT.State = {
        ...
        Custom: true               // Custom builder activated
    };
    ...
    PT.Start = function (showPreview, webKeyGUID) {
        ...
        if (webKeyGUID == "73e46a7f-6f0f-46c8-ab4b-00ba64ae6d83") {
            $(".custom-only").show();
        }
        ...
        $('#planSelector').on("click", "input[type='image']", function (evt) {
...
var CB = {
    ...
    FX: {
        ...
        loadUserSession: function () {
            ...
            localStorage['CB.userEmail'] = PT.State.Email;
            localStorage['CB.sessionGUID'] = PT.State.SessionGuid;
        },
