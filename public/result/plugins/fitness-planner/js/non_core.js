/*
 * WARNING -                CONTAINS FITNESS MENTOR PATCH!!  SEARCH FOR FITNESS
 *
 *
 *
	...
	$.extend(Timepicker.prototype, {
		...
		*/
		_newInst: function($input, o) {
			...
			if(typeof(tp_inst._defaults.controlType) === 'string'){
				if(tp_inst._defaults.controlType == 'slider' && typeof(jQuery.ui.slider) === 'undefined'){ // jQuery.ui.slider
		...
		*/
		_parseTime: function (timeString, withDate) {
		    ...
		    /* FITNESS MENTOR: BEGIN PATCH - It will support mm:ss format considering hours to be 00 
             * apply "00:" prefix as long as it does not contain a date.  */
		    if (timeString.split(":").length == 2 && (timeString.split("-").length == 0)) {
