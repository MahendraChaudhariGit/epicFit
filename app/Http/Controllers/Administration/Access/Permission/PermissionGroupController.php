...
class PermissionGroupController extends Controller
{
    ...
    {
        return view('administration.access.roles.permissions.groups.create');
    }
    ...
    public function store(StorePermissionGroupRequest $request)
    {
        ...
        return redirect()->route('administration.access.roles.permissions.index')->withFlashSuccess(trans('alerts.administration.permissions.groups.created'));
    }
    ...
    {
        return view('administration.access.roles.permissions.groups.edit')
    ...
    public function destroy($id, DeletePermissionGroupRequest $request)
    {
        ...
        return redirect()->route('administration.access.roles.permissions.index')->withFlashSuccess(trans('alerts.administration.permissions.groups.deleted'));
    }
