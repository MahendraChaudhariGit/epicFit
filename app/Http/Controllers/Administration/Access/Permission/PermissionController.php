...
class PermissionController extends Controller
{
    ...
    {
        return view('administration.access.roles.permissions.index')
    ...
    {
        return view('administration.access.roles.permissions.create')
    ...
    public function store(StorePermissionRequest $request)
    {
        ...
        return redirect()->route('administration.access.roles.permissions.index')->withFlashSuccess(trans('alerts.administration.permissions.created'));
    }
    ...
    public function edit($id, EditPermissionRequest $request)
    {
        ...
        return view('administration.access.roles.permissions.edit')
    ...
    public function update($id, UpdatePermissionRequest $request)
    {
        ...
        return redirect()->route('administration.access.roles.permissions.index')->withFlashSuccess(trans('alerts.administration.permissions.updated'));
    }
    ...
    public function destroy($id, DeletePermissionRequest $request)
    {
        ...
        return redirect()->route('administration.access.roles.permissions.index')->withFlashSuccess(trans('alerts.administration.permissions.deleted'));
    }
}
