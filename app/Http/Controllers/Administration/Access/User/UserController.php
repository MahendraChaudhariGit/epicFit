...
namespace App\Http\Controllers\Administration\Access\User;
...
class UserController extends Controller
{
    ...
    {
        return view('administration.access.index')
            ->withUsers($this->users->getUsersPaginatedForAdministration(config('access.users.default_per_page'), 1));
    }
    ...
    {
        return view('administration.access.create')
    ...
    public function store(StoreUserRequest $request)
    {
        ...
        User::where('id', $user->id)
            ->update(['account_id' => $admin->id]);

        return redirect()->route('administration.access.users.index')->withFlashSuccess(trans('alerts.backend.users.created'));
    }
    ...
    public function edit($id, EditUserRequest $request)
    {
        ...
        return view('administration.access.edit')
            ->withUser($user)
    ...
    public function update($id, UpdateUserRequest $request)
    {
        ...
        return redirect()->route('administration.access.users.index')->withFlashSuccess(trans('alerts.backend.users.updated'));
    }
    ...
    {
        return view('administration.access.deactivated')
    ...
    {
        return view('administration.access.deleted')
    ...
    {
        return view('administration.access.change-password')
    ...
    public function updatePassword($id, UpdateUserPasswordRequest $request)
    {
        ...
        return redirect()->route('administration.access.users.index')->withFlashSuccess(trans('alerts.backend.users.updated_password'));
    }
