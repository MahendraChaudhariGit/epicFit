...
<fieldset class="padding-15">
    ...
    <div class="row">
        <div class="col-md-6">
                <div class="form-group">
                    ...
                    <span class="referrerCls">
                       <b> Name</b> - @if(isset($sleep_questionnaire) && !empty($sleep_questionnaire->first_name)) {{ $sleep_questionnaire->first_name }} {{ $sleep_questionnaire->last_name }} @else {{ $clients->firstname }} {{ $clients->lastname }} @endif <br>
                       <b>Contact Number</b> - @if(isset($sleep_questionnaire) && !empty($sleep_questionnaire->contact_number)) {{ $sleep_questionnaire->contact_number }} @else {{ $clients->phonenumber }} @endif <br>
                       ...
                       <b>Email</b> - @if(isset($sleep_questionnaire) && !empty($sleep_questionnaire->email)) {{ $sleep_questionnaire->email }} @else {{ $clients->email }} @endif <br>
                       <b>Gender</b> - @if(isset($sleep_questionnaire) && !empty($sleep_questionnaire->gender)) {{ $sleep_questionnaire->gender }} @else {{ $clients->gender }} @endif <br>
                       <b>Age</b> - @if(isset($sleep_questionnaire) && !empty($sleep_questionnaire->age)) {{ $sleep_questionnaire->age }} @else {{ Carbon::parse($clients->birthday)->age }} @endif <br>
        ...
        <div class="col-md-12">
            <button type="button" class="btn btn-primary edit-mode1 btn-wide pull-right">
                Edit 
            </button>
        </div>
    </div>
