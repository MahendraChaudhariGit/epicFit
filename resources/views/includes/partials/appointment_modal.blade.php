                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row m-t-5">
                                                    ...
                                                    <div class="col-md-2 form-group m-b-0 onchange-set-neutral">
                                                        {!! Form::select('serviceDur0', ['' => '-- Select --', '5' => '5 min', '10' => '10 min', '15' => '15 min', '20' => '20 min', '25' => '25 min', '30' => '30 min', '35' => '35 min', '40' => '40 min', '45' => '45 min', '50' => '50 min', '55' => '55 min', '60' => '60 min'], null, ['class' => 'form-control serviceDur', 'required']) !!}
                                                    </div>
                                                    <div class="col-md-2 form-group m-b-0">
                                                        {!! Form::text('servicePrice0', null, ['class' => 'form-control price-field servicePrice', 'required']) !!}
                                                    </div>
                                                    <div class="col-md-1">
