        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <ul id="classTabs" class="nav nav-tabs ">
                    <li class="active">
                        <a href="#addexerciseImage" data-toggle="tab">
                            <i class="fa fa-cutlery"></i> Add Exercise
                        </a>
                    </li>
                    <li>
                        <a href="#addexerciseVideo" data-toggle="tab">
                            <i class="fa fa-cutlery"></i> Add Exercise Video
                        </a>
                    </li>
                </ul>
                <div class="tab-content">
                    <div class="tab-pane fade in active" id="addexerciseImage">
                        <div class="row">
                        ...
                        <div style="max-height:200px;overflow-y:scroll;overflow-x:hidden"><!--class="exercise_list" -->
                          <div class="row" id="exerciseList" data-plan-type="1">
                            <!--<div class="col-md-4">
                    ...
                    <div class="tab-pane fade" id="addexerciseVideo">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="strong">Workout Type</label>
                                    <select class="form-control" name="filter" id="filterVideo">
                        ...
                        <div class="row">
                            <div class="exerciseVideoListing" id="exerciseVideoListing" data-work-out="" data-program-id="" data-plan-type="2">
                            </div>
                        </div>
                    </div>
                </div>
