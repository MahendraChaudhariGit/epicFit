    ...
    <div class="col-sm-5 col-md-4">
        <div class="user-left">
            <div class="center">
                ...
                Amount Paid: ${{ $selectedMemberShip->cm_emi }}
                <br>
                Next Payment: ${{ (count($nextMemberShip))?$nextMemberShip->cm_next_emi:$selectedMemberShip->cm_next_emi }}
                <br>
                Due Date: {{ $selectedMemberShip->cm_due_date ? dbDateToDateString( $selectedMemberShip->cm_due_date ) : '' }}
                <!--<div>
