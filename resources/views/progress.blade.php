...
<div id="GalleryBeforeAfter" class="tab-pane">
    ...
    <div class="galleryformsection">
          <form method="POST" action="{{ url('client/save-final-progress') }}" enctype="multipart/form-data" id="save-final-progress-form">
            @csrf
        <div class="top_field">
            <div class="row">
        ...
        <div class="galleryDragAndDrop">
            ...
            <label for="upload-file" class="drag-area upload-area">
                <img src="{{asset('/1.png')}}">                
                <div class="text" >
            ...
            <div class="col-md-12 text-right" style="display:none;" id="save-progress-btn">
                  ...
                  <div class="form-group">
                    <div class="checkbox clip-check check-primary m-b-0">
                        <input id="admin_manage" type="checkbox" name="only_admin_manage" value="yes">
