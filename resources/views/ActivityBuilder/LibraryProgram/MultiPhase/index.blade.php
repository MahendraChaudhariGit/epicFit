...
@section('page-title')
    Multi Phase Library Program list
    @if(isUserType(['Admin']) && Auth::user()->hasPermission(Auth::user(), 'create-library-program'))  
        <a class="btn btn-primary pull-right" href="{{ route('libraryprogram.createMultiPhase') }}"><i class="ti-plus"></i> Add Multi Phase Library Program</a>
    @endif
@stop
                        ...
                        <tr>
                            ...
                            <td class="center">
                                <div>
                                    ...
                                    <a class="btn btn-xs btn-default tooltips" href="{{ route('libraryprogram.editMultiPhase', $libraryProgram->id) }}" data-placement="top" data-original-title="Edit">
