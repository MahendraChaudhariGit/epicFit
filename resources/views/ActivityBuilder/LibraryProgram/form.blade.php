...
<div class="row">
    <div class="col-sm-12">
        <div class="form-group">
            @if(isset($libraryProgram))
            <button type="button" class="btn btn-primary btn-wide pull-right savePlanBtn" data-target-step="trainingSegment" data-plan-type="6" data-weeks="{{$libraryProgram->weeksToExercise}}" data-day-option="{{$libraryProgram->dayOption}}" data-days-in-week="{{$libraryProgram->noOfDaysInWeek}}" data-day-pattern="{{$libraryProgram->daysOfWeek}}">
                Next <i class="fa fa-arrow-circle-right"></i>
            </button>
            @else
            <button type="button" class="btn btn-primary btn-wide pull-right savePlanBtn" data-target-step="trainingSegment">
                Next <i class="fa fa-arrow-circle-right"></i>
            </button>
            @endif
        </div>
