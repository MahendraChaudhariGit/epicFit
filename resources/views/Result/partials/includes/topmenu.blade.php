...
<div id="mainnav" class="top_navigation">
    <ul class="main-navigation-menu">
        <li class="{{ Request::is('new-dashboard')?'active':'' }}">
        ...
        <!-- Calendars end -->
        <!-- Epic Process end -->
        <li class="{{ Request::is('parq')?'active':'' }}">
            <a href="#">
                <div class="item-content">
                    <div class="item-media">
            ...
            <ul class="topsub-menu">
                <div class="submenu_back"> 
                    <li class="{{in_array('parq', $clientSelectedMenus)?'':'disable'}}">
                        <a href="#">
                            <div class="menuicon">
                    ...
                    <li class="">
                        ...
                        <ul class="topsub-sub-menu">
                            <div class="submenu_back"> 
                                <li class="">
                                    <a href="{{ url('epicprogress/WeightAndDate/Measurements') }}">
                                        <div class="menuicon">
                                ...
                                <li class="">
                                    <a href="{{ url('epicprogress/WeightAndDate/smarater') }}">
                                        <div class="menuicon">
                                ...
                                <li class="">
                                    <a href="{{ url('epicprogress/WeightAndDate/motivation') }}">
                                        <div class="menuicon">
                    ...
                    <li class="">
                        ...
                        <ul class="topsub-sub-menu">
                            <div class="submenu_back"> 
                                <li class="">
                                    <a href="{{ url('epicprogress/train-gain/strength-in-numbers') }}">                                      
                                        <div class="menuicon">
                                ...
                                <li class="">
                                    <a href="{{(Auth::id() == 78 || 1==1) && in_array('fitness_mapper', $clientSelectedMenus)?url('epicprogress/train-gain/fitness-mapper'):"#"}}" class="{{(Auth::id() == 78 || 1==1) && in_array('fitness_mapper', $clientSelectedMenus)?'':'disable'}}">                                                
                                        <div class="menuicon">
                                ...
                                <li class="">
                                    <a href="{{ url('epicprogress/train-gain/rest-in-recovery') }}">
                                        <div class="menuicon">
                    ...
                    <li class="">
                        ...
                        <ul class="topsub-sub-menu">
                            <div class="submenu_back"> 
                                <li class="">
                                    <a href="{{ url('epicprogress/trace-and-replace/nutritional-journal') }}">
                                        <div class="menuicon">
                                            <img src="{{asset('result/images/Meal Description.png')}}">
                                        </div>
                                        <div class="item-inner">
                                ...
                                <li class="">
                                    <a href="{{ url('epicprogress/trace-and-replace/portion-distrortion') }}">
                                        <div class="menuicon">
                                ...
                                <li class="">
                                    <a href="{{ url('epicprogress/trace-and-replace/limiting-vices') }}">
                                        <div class="menuicon">
                    ...
                    <li class="">
                        ...
                        <ul class="topsub-sub-menu">
                            <div class="submenu_back"> 
                                <li class="">
                                    <a href="{{ url('epicprogress/diarise-and-prioritise/stay-focused') }}">
                                        <div class="menuicon">
                                ...
                                <li class="">
                                    <a href="{{ url('epicprogress/diarise-and-prioritise/revise-adjust') }}">
                                        <div class="menuicon">
                                ...
                                <li class="">
                                    <a href="{{ url('epicprogress/diarise-and-prioritise/consistency-beats') }}">
                                        <div class="menuicon">
                                ...
                                <li class="">
                                    <a href="{{ url('epicprogress/diarise-and-prioritise/bucket-list') }}">
                                        <div class="menuicon">
                                ...
                                <li class="">
                                    <a href="{{ url('epicprogress/diarise-and-prioritise/celebrate') }}">
                                        <div class="menuicon">
