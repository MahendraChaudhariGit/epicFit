...
<fieldset class="padding-15">
    ...
    <form action="{{ url('epic/chronotype-survey') }}" method="post" enctype="multipart/form-data">
        @csrf 
    ...
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <button type="button" class="btn btn-danger remove-edit-mode2 btn-wide pull-right"  style="margin-right: 10px;">
                Cancel 
            </button>
        </div>
    </div>
