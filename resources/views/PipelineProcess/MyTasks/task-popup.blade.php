...
<div class="mx-auto max-w-xl">
    <div class="bg-white rounded-lg shadow-xl transform transition-all sm:max-w-xl sm:w-full">
        ...
        <div class="showEditTask mt-1 flex rounded-md shadow-sm" style="display: none">
        <div class="relative flex-grow focus-within:z-10">
            ...
            <select class="form-control task-name{{ $task->task_id }}">
                ...
                <option @if($client['id'] == $task->parent->content) selected @endif value="{{ $client['id'] }}">{{ $client['name'] }}</option>
                @endforeach
            </select> 
        </div>
        ...
        @endphp
            <div class="pl-3 checktask w-full">
                ...
                <div class="w-full bg-white shadow-xs hide{{$task->parent->column->id}}{{$task->task_id}}" style="display: {{$hidden}}">
                        ...
                        @endphp
                            <div>
                                <input id="myCheckBox1{{$task->id}}complementary_teams" type="checkbox" {{ $check11 }} proccess-data="complementary_teams"
                                class="myCheckBox1{{$task->id}}complementary_teams myCheckBox1{{$task->id}} form-checkbox w-6 h-6 rounded-full text-green-400" 
                                onclick="salesCheck({{ $task->id }},{{ $task->parent->column->id }},'complementary_teams',{{($json->teamCount ? $json->teamCount : 0) + ($json->indivCount ? $json->indivCount : 0) + 1}})">
                            </div>
                            
                            <div class="pl-3 w-full">
                                <div class="w-full text-sm">
                                    <label for="myCheckBox1{{$task->id}}complementary_teams" class="cursor-pointer mb-0">
                                        Complementary Teams
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="flex items-center py-2 mb-1 rounded-lg">
                            <div>
                                <input id="myCheckBox1{{$task->id}}team{{ $i }}" type="checkbox" {{$check}} class="myCheckBox1{{$task->id}}team{{ $i }} myCheckBox1{{$task->id}} form-checkbox w-6 h-6 rounded-full text-green-400" 
                                onclick="salesCheck({{ $task->id }},{{ $task->parent->column->id }},'team{{ $i }}',{{($json->teamCount ? $json->teamCount : 0) + ($json->indivCount ? $json->indivCount : 0) + 1}})">
                            </div>
                            
                            <div class="pl-3 w-full">
                                <div class="w-full text-sm">
                                    <label for="myCheckBox1{{$task->id}}team{{ $i }}" class="cursor-pointer mb-0">
                                        TEAM {{$i}} 
                                    </label>
                                </div>
                            </div>
                    ...
                    <div class="flex flex-col ml-5">
                        ...
                        <div class="flex items-center py-2 mb-1 hover:bg-gray-100 rounded-lg">
                            ...
                            <div>
                                <input id="myCheckBox1{{$task->id}}indiv{{ $i }}" type="checkbox" {{$check}} class="myCheckBox1{{$task->id}}indiv{{ $i }} myCheckBox1{{$task->id}} form-checkbox w-6 h-6 rounded-full text-green-400" 
                                onclick="salesCheck({{ $task->id }},{{ $task->parent->column->id }},'indiv{{ $i }}',{{($json->teamCount ? $json->teamCount : 0) + ($json->indivCount ? $json->indivCount : 0) + 1}})">
                            </div>
                            
                            <div class="pl-3 w-full">
                                <div class="w-full text-sm">
                                    <label for="myCheckBox1{{$task->id}}indiv{{ $i }}" class="cursor-pointer mb-0">
                                        INDIVIDUAL {{ $i }}
                                    </label>
                                </div>
                            </div>
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <div class="cursor-pointer mb-0">
                                        @if (!empty($project_columns))
                                            @foreach ($project_columns as $key1=>  $project_column)
                                            @php
                                            // if($task->parent->column->name == $project_column){
                                            //     $disable = '';
                                            // }else{
                                            //     $disable = 'disabled';
                                            // }
                                            ...
                                            <div class="panel-default flex flex-col">
                                                ...
                                                <div class="pl-2 pb-1 border-b border-gray-200 mb-1 mt-1 gray-bg">
                                                    <div class="flex items-center rounded-lg">
                                                        <div class="mr-2">
                                                            <input type="checkbox" {{ $disable }} {{ $visibility }} class="form-checkbox w-6 h-6 rounded-full text-green-400 check-column" task-id="{{ $task->task_id }}" column-id="{{ $key1 }}" data-from="complimentry">
                                                        </div>
                                                ...
                                                <div id="collapse{{$key1}}{{$task->id}}"  class="collapse">
                                                    ...
                                                    <div class="row"> 
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <div class="flex items-center py-2 mb-1 rounded-lg">
                                                                <div>
                                                                    <input id="myCheckBox{{$task->id}}team{{ $i }}" type="checkbox" {{$check}} {{ $disable }} proccess-data='team{{ $i }}'
                                                                    class="myCheckBox{{$task->id}}team{{ $i }} myCheckBox{{$task->id}} form-checkbox w-5 h-5 rounded-full text-green-400" 
                                                                    onclick="checkMe({{ $task->id }},{{ $key1 }},'team{{ $i }}',{{($json->teamCount ? $json->teamCount : 0) + ($json->indivCount ? $json->indivCount : 0) + 1}})">
                                                                </div>
                                                                
                                                                <div class="pl-3 w-full">
                                                                    <div class="w-full text-sm">
                                                                        <label for="myCheckBox{{$task->id}}team{{ $i }}" class="cursor-pointer mb-0">
                                                                            TEAM {{$i}} 
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            ...
                                                            <div class="flex items-center py-2 mb-1 rounded-lg">
                                                                ...
                                                                <div>
                                                                    <input id="myCheckBox{{$task->id}}indiv{{ $i }}" type="checkbox" {{$check}} {{ $disable }} proccess-data="indiv{{ $i }}"
                                                                    class="myCheckBox{{$task->id}}indiv{{ $i }} myCheckBox{{$task->id}} form-checkbox w-5 h-5 rounded-full text-green-400" 
                                                                    onclick="checkMe({{ $task->id }},{{ $key1 }},'indiv{{ $i }}',{{($json->teamCount ? $json->teamCount : 0) + ($json->indivCount ? $json->indivCount : 0) + 1}})">
                                                                </div>
                                                                
                                                                <div class="pl-3 w-full">
                                                                    <div class="w-full text-sm">
                                                                        <label for="myCheckBox{{$task->id}}indiv{{ $i }}" class="cursor-pointer mb-0">
                                                                            INDIVIDUAL {{ $i }}
                                                                        </label>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                        ...
                                                        @endphp
                                                            <div>
                                                                <input id="myCheckBox{{$task->id}}complementary_teams" type="checkbox" {{ $check11 }} proccess-data="complementary_teams"
                                                                class="myCheckBox{{$task->id}}complementary_teams myCheckBox{{$task->id}} form-checkbox w-5 h-5 rounded-full text-green-400" 
                                                                onclick="checkMe({{ $task->id }},{{ $key1 }},'complementary_teams',{{($json->teamCount ? $json->teamCount : 0) + ($json->indivCount ? $json->indivCount : 0) + 1}})">
                                                            </div>
                                                            
                                                            <div class="pl-3 w-full">
                                                                <div class="w-full text-sm">
                                                                    <label for="myCheckBox{{$task->id}}complementary_teams" class="cursor-pointer mb-0">
                                                                        Complementary Teams
                                                                    </label>
                                                                </div>
                                                            </div>
