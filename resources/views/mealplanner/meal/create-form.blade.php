<div class="form-group">
    ...
    <input value="1" class="reipe_format" name="reipe_format" hidden>
    <div class="recipes-form__style">
        <label class="recipes-form__style-label simple >
                    <input type=" radio"
            name="recipe_style">Simple
        </label>
...
<div class="form-group">
    ...
    <div class="ingredients2">
        ...
        required</span>
        <input type="text" name="ingredient_name_1" value="" class="form-control"
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h3><span>Analyze your meal</span>
                            <div class="tips" data-toggle="modal" data-target="#myModalTips">Tips
                            </div>
                        </h3>
                    </div>
                </div>
    ...
    <div class="analyze-your-meal form-group">
        ...
        <div class="row">
            <div class="col-md-12 core">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <textarea class="form-control analyze" id="ingredients-2" name="ingr_textarea_1" placeholder="For example:
1 cup orange juice
3 tablespoons olive oil
2 carrots" rows="" autocomplete="off"></textarea>
                    </div>
                </div>
            </div>
        </div>
...
<div class="form-group">
    <span class="preparation-help-block" style="display: none;color: red;">please add preparation</span>
    ...
    <div class="optionBox preparation2">
        <span class="preparation-help-block-2" style="display: none;color: red;">please add preparation</span>
