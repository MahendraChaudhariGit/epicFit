      <div class="col-md-9">
        <fieldset class="padding-15">
            ...
            <div class="row">
                {!! Form::open(['url' => '','id'=>'meal-cal-form']) !!}
                <div class="col-md-12">
                    <div class="form-group" id="form-group-edit" style="display: none;">
                        
                    </div>
                    <div class="form-group" id="form-group-create">
                        <textarea name="name" id="name" class="form-control custom-foods-textarea" placeholder="Copy & paste your foods here! Make sure to list one ingredient per line."></textarea>
                    </div>
                    <div class="row">
