<!-- sole trader modal -->
<div class='modal fade' id='sole-trader-tax-modal' tabindex='-1'>
    <div class='modal-dialog'>
        <div class='modal-content'>
            <div class='modal-header'>
                <button aria-hidden='true' class='close' data-dismiss='modal' type='button'>×</button>
                <h4 class='modal-title' id='myModalLabel'>Sole Trader Tax</h4>
            </div>
            <div class='modal-body'>
                <input type="hidden" id="country" name="country" value="NZ">
                <div class="row">
                    <div class="col-md-12">
                        <input type="hidden" class="tax_category" value="sole-trader">
                        <div class="form-group">
                            <label class="strong" for="other_tax_type">Type</label>
                            <select id="other_tax_type" name="tax_type" class="form-control tax_type" disabled>
                ...
                <div class="row">
                    ...
                    <div class="dynamicSec otherDynamicSec">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="Tax">
                                    <div class="col-md-4">
                            ...
                            <div class="col-md-12">
                                <div class="Tax">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <button type="button" class="btn btn-primary btn-o btn-sm  incTaxBtn p-y-0
                                        pull-right add_income_tax_field_btn" data-id="0"
                ...
                <div class='modal-footer'>
                    ...
                    <button class='btn btn-primary overflow' id="save-other-tax" data-dismiss='modal' type='button'>
                        Save </button>
                    <button class='btn btn-primary overflow' id="update-other-tax"  type='button'
                            class='close' data-dismiss='modal'> Update </button>
                </div>
            </div>
        </div>
    </div>
