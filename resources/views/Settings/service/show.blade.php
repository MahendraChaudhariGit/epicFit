							...
							<div class="user-left">
								...
								<div>
									<div class="user-image">
										<div class="thumbnail">
											@if($serviceCatogory == '1 on 1')
												<img src="{{ dpSrc($service->one_on_one_training_logo) }}" class="img-responsive servicePreviewPics previewPics" id="profile-userpic-img" alt="{{ $service->one_on_one_name }}">
											@else
												<img src="{{ dpSrc($service->team_training_logo) }}" class="img-responsive servicePreviewPics previewPics" id="profile-userpic-img" alt="{{ $service->team_name }}">
											@endif				                        
										</div>
								...
								if($serviceCatogory == 'TEAM Training') { ?>
                                  <table class="table table-condensed table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <tr>
											<td>Colour:</td>
                                           <input id ="team-colure" type="hidden" name="entityId" value="{{$service->team_colour}}">
											<td><div class ="team-colour">&nbsp; </div></td>
											<td><a href="#panel_edit_account" class="show-tab"><i class="fa fa-pencil edit-user-info"></i></a></td>
										</tr>
                                         <tr>
											<td>Duration:</td>
											<td>{{$service->team_duration}}</td>
											<td><a href="#panel_edit_account" class="show-tab"><i class="fa fa-pencil edit-user-info"></i></a></td>
										</tr>
                                         <tr>
											<td>Capacity:</td>
											<td>{{$service->team_capacity}}</td>
											<td><a href="#panel_edit_account" class="show-tab"><i class="fa fa-pencil edit-user-info"></i></a></td>
										</tr>
                                        <tr>
                                ...
                                <?php } else if($serviceCatogory == '1 on 1') { ?>
                                 <table class="table table-condensed table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <tr>
											<td>Colour:</td>
                                            <input id ="one-colure" type="hidden" name="entityId" value="{{$service->one_on_one_colour}}">
											<td><div class ="team-colour">&nbsp; </div></td>
											<td><a href="#panel_edit_account" class="show-tab"><i class="fa fa-pencil edit-user-info"></i></a></td>
										</tr>
                                         <tr>
											<td>Duration:</td>
											<td>{{$service->one_on_one_duration}}</td>
											<td><a href="#panel_edit_account" class="show-tab"><i class="fa fa-pencil edit-user-info"></i></a></td>
										</tr>
                                         <tr>
											<td>Capacity:</td>
											<td>{{$service->one_on_one_capacity}}</td>
											<td><a href="#panel_edit_account" class="show-tab"><i class="fa fa-pencil edit-user-info"></i></a></td>
										</tr>
                                        <tr>
											<td>Staff Selection:</td>
...
$(document).ready(function() {
	var colure = $('#one-colure').val();
	 colure = $('#one-colure').val();
	$('.team-colour').css('background-color', colure)
});
</script>
@stop