...
<fieldset class="padding-15">
    ...
    <form action="{{ url('epic/store-sleep-questionnaire') }}" method="post" enctype="multipart/form-data">
        @csrf 
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="form-group">
                ...
                <input type="text" name="first_name" value="@if(isset($sleep_questionnaire) && !empty($sleep_questionnaire->first_name)) {{ $sleep_questionnaire->first_name }} @else {{ $clients->firstname }}  @endif" class="form-control">
            </div>
            <div class="form-group">
                <label class="strong">Last Name</label>
                <input type="text" name="last_name" value="@if(isset($sleep_questionnaire) && !empty($sleep_questionnaire->last_name)) {{ $sleep_questionnaire->last_name }} @else {{ $clients->lastname }} @endif" class="form-control">
            </div>
            <div class="form-group">
                <label class="strong">Contact Number</label>
                <input type="text" name="contact_number" value="@if(isset($sleep_questionnaire) && !empty($sleep_questionnaire->contact_number)) {{ $sleep_questionnaire->contact_number }} @else {{ $clients->phonenumber }} @endif" class="form-control">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="email" value="@if(isset($sleep_questionnaire) && !empty($sleep_questionnaire->email)) {{ $sleep_questionnaire->email }} @else {{ $clients->email }} @endif" class="form-control">
            </div>
            <div class="form-group">
                <label class="strong">Gender</label>
                <input type="text" name="gender" value="@if(isset($sleep_questionnaire) && !empty($sleep_questionnaire->gender)) {{ $sleep_questionnaire->gender }} @else {{ $clients->gender }} @endif" class="form-control">
            </div>
            <div class="form-group">
                <label class="strong">Age</label>
                <input type="text" name="age" value="@if(isset($sleep_questionnaire) && !empty($sleep_questionnaire->age)) {{ $sleep_questionnaire->age }} @else {{ Carbon::parse($clients->birthday)->age }} @endif" class="form-control">
            </div>
            <div class="form-group">
                <label class="strong">Date</label>
                <input type="text" name="date" id="datepicker1" value="@if(isset($sleep_questionnaire) && !empty($sleep_questionnaire->date)){{ $sleep_questionnaire->date }}@else  @endif" class="form-control">
            </div>
        ...
        <div class="col-md-12">
            ...
            <button type="button" class="btn btn-danger remove-edit-mode1 btn-wide pull-right"  style="margin-right: 10px;">
                Cancel 
            </button>
        </div>
    </div>
